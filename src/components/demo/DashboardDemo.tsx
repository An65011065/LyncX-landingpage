...
import GhostTab from "./GhostTabDemo";
import WeeklyInsights from "./WeeklyInsightsDemo";
import Timers from "./TimersDemo";
import Templates from "./TemplatesDemo";
import WebsiteBlocker from "./BlockerDemo";
import NotesOverview from "./NotesDemo";
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Use Google Fonts instead of Chrome extension fonts */}
                <style>{`
                ...
                >
                    ...
                    >
                        <div style={{ width: "70%", height: "100%" }}>
                            <StoriesDemo isDarkMode={isDarkMode} />
                        </div>
                        <div
                            style={{
                                width: "30%",
